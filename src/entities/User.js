...
let User = (() => {
    ...
    var User = _classThis = class {
        constructor() {
            ...
            this.ciudad = __runInitializers(this, _ciudad_initializers, void 0);
    ...
    (() => {
        ...
        _telefono_decorators = [(0, typeorm_1.Column)()];
        _ciudad_decorators = [(0, typeorm_1.Column)()];
        ...
        __esDecorate(null, null, _ciudad_decorators, { kind: "field", name: "ciudad", static: false, private: false, access: { has: obj => "ciudad" in obj, get: obj => obj.ciudad, set: (obj, value) => { obj.ciudad = value; } }, metadata: _metadata }, _ciudad_initializers, _instanceExtraInitializers);
        __esDecorate(null, null, _estado_decorators, { kind: "field", name: "estado", static: false, private: false, access: { has: obj => "estado" in obj, get: obj => obj.estado, set: (obj, value) => { obj.estado = value; } }, metadata: _metadata }, _estado_initializers, _instanceExtraInitializers);
